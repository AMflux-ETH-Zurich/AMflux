...
def axis_configuration_init(node, sens_res: int=None , sys_speed: int=None): 
    ...
    node.sdo[("Axis configuration.Control structure", 0x02)].raw = 0b00000000000000100000000100100001
    #Commutaton Sensors
...
def abort_connection_option_init(node, abort_option: int = None):
    ...
    node.sdo["Shutdown option code"].raw = abort_option if abort_option is not None else 3
